 ...
 useEffect(() => {
  ...
  return (data 
    ...
    <div className="flex lg:h-screen tracking-wide flex-col h-full lg:flex-row">
     <div className="w-full lg:w-1/2 h-full bg-cyan-500 flex flex-col justify-center p-16 text-white">
       ...
       <h7 className="text-7xl animate__animated animate__fadeInDown">
